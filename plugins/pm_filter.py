...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡contact Admin if any error⚡", url='https://telegram.me/CapTa1_n')
        ] 
    )
    ...
    if query.data.startswith("file"):
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"⚡️ Want Actress PAid Videos 🦋", url=f"https://telegram.me/Real_MdiskBlast")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡Premium Videos⚡", url='https://telegram.me/Mdisk_blast_membership'),
        ] 
    )
    if offset != "":
