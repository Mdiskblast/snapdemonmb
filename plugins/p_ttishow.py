...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Premium Videos', url='https://t.me/Mdisk_blast_membership')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat,
            text='<b>Hello Friends, \nMy admin has told me to leave from group so i go! If you wanna use me again contact my Admin.</b>',
            reply_markup=reply_markup,
        )
...
async def disable_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat_, 
            text=f'<b>Hello Friends, \nMy admin has told me to leave from group, isiliye main chali 🤪 ! If you wanna use me again contact my Admin.</b> \nReason : <code>{reason}</code>',
            reply_markup=reply_markup)
